...
- 把 compare-only offline lane 继续往真实成功 runner 的标题 / kind / body 语义收口，而不是只停在共享 4-branch 结构基线
- 把 compare 输出继续补到更稳定的字段级、结构级差异归因；当前已经有成功 pair detail / metrics / structure details 的 machine-readable 基线
